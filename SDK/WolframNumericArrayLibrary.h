...
RTL_DLL_EXPORT errcode_t MNumericArray_newDLL(const numericarray_data_t type, const mint rank, const mint* dims,
											  MNumericArray* res);
RTL_DLL_EXPORT errcode_t MNumericArray_clone(const MNumericArray from, MNumericArray* to);
RTL_DLL_EXPORT void MNumericArray_free(MNumericArray narray);
RTL_DLL_EXPORT void MNumericArray_disown(MNumericArray narray);
RTL_DLL_EXPORT void MNumericArray_disownAll(MNumericArray narray);
RTL_DLL_EXPORT mint MNumericArray_shareCount(const MNumericArray narray);
RTL_DLL_EXPORT numericarray_data_t MNumericArray_getTypeDLL(const MNumericArray narray);
RTL_DLL_EXPORT mint MNumericArray_getRankDLL(const MNumericArray narray);
RTL_DLL_EXPORT mint const* MNumericArray_getDimensionsDLL(const MNumericArray narray);
RTL_DLL_EXPORT mint MNumericArray_getFlattenedLength(const MNumericArray narray);
RTL_DLL_EXPORT void* MNumericArray_getData(const MNumericArray narray);
RTL_DLL_EXPORT errcode_t MNumericArray_convertType(MNumericArray* outP, const MNumericArray narray,
